...
<center>![error_when_typed_only_numbers](../../media/backend/custom-password-validator/error1.png)</center>

숫자가 안 들어간 오로지 글자만 쳤을 경우,

<center>![error_when_typed_only_numbers](../../media/backend/custom-password-validator/error2.png)</center>

영소문자와 숫자만 쳤을 경우,

<center>![error_when_typed_only_numbers](../../media/backend/custom-password-validator/error3.png)</center>

그리고 마지막으로 특수문자를 생략했을 경우,

<center>![error_when_typed_only_numbers](../../media/backend/custom-password-validator/error4.png)</center>
