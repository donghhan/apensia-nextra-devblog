...
description: 'poetry로 psycopg2 패키지를 설치하는 도중 발생된 에러'
---
...
[^1]: 참고: <a href="https://developer.apple.com/library/archive/technotes/tn2339/_index.html" target="_blank">What is the Command Line Tools Package?</a>
