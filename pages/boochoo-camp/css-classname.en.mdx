...
BEM method provided us with good guideline for how to make consistent class names.
However, it just made us feel uncomfortable for maintaing too much long class names and debugging.
After using module method, it could resolve complexity of class names and reduced about 15% in debugging time.
