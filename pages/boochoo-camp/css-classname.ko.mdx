...
BEM 방법론의 경우 규칙성있게 클래스명을 작성하는 가이드라인을 제공하는 데에는 충분하였지만 결국 수없이 남발하게 되는 요소와 수식어로 인해 클래스명이 복잡해질 뿐더러 디버깅하는 데에도 오히려 불편했다.
모듈 방식을 사용하게 되면서 클래스명의 복잡성에 대한 부분도 해소되었고 디버깅하는 시간도 15% 가량 다소 줄어들었다.
